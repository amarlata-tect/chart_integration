...
/**
 * Provides dynamic permissions for Chart entity of different types.
 *
 * @ingroup chart_intigration
 *
 */
class ChartEntityPermissions{
   ...
   *
   * @return array
   *   The ChartEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (ChartEntity::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\chart_intigration\Entity\ChartEntity $type
   *   The ChartEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(ChartEntity $type) {
    $type_id = $type->id();
