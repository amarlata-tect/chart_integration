...
/**
 * Provides a form for reverting a Chart entity revision.
 *
 * @ingroup chart_intigration
 */
class ChartEntityRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'chart_entity_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Chart entity: reverted %title revision %revision.', ['%title' => $this->revision->label(), '%revision' => $this->revision->getRevisionId()]);
    $this->messenger()->addMessage(t('Chart entity %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\chart_intigration\Entity\ChartEntityInterface $revision
   ...
   */
  protected function prepareRevertedRevision(ChartEntityInterface $revision, FormStateInterface $form_state) {
